...
const PostComment = () => {
    ...
    const location = useLocation(); // Provide type annotation for useLocation hook
    ...
    useEffect(() => {
        const fetchComments = async () => {
            try {
                ...
                const postComments = location.state ? location.state.comments : [];
    ...
    return (<div>
        ...
        <div className="comments-container">
          {comments.length === 0 ? (<p>No comments available.</p>) : (<ul className="comments-list">
