...
function Login() {
    ...
    return (<div className="login-container">
      ...
      <input ref={emailInputRef} type="email" className="login-input" placeholder="Email" value={email} onChange={(e) => setEmail(e.target.value)}/>
      {emailInputRef.current?.value && !emailInputRef.current.value.includes('@') &&
            (<p className="text-white">Invalid email</p>)}
             {emailError && <p className="error-message">{emailError}</p>}
      <input ref={passwordInputRef} type="password" className="login-input" placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)}/>
