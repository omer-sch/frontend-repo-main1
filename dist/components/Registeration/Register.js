...
function Register() {
    ...
    return (<div className="register-container">
      ...
      <div className="d-flex justify-content-center position-relative">
        ...
        {ImgSrc ? (<img src={URL.createObjectURL(ImgSrc)} alt="avatar" className="avatar-preview"/>) : (<img src={avatar} alt="avatar" className="avatar-preview"/>)}
      ...
      {nameInputRef.current?.value && (nameInputRef.current.value.length < 2 || nameInputRef.current.value.length > 30 || !nameInputRef.current.value.includes(' ')) && (<p className="text-white">Name must have 2 until 30 characters and contain space</p>)}
